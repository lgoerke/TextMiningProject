...
def cluster(print_number):
	...
	logname = 'log_pca_' + print_number +'.txt'
	f = open(logname, 'w')
	sys.stdout = f
	sys.stderr = f
	...
	filepath = 'data/reviews_categorical01.pkl'
	a = pickle.load(open(filepath,'rb'))
	print(len(a))
	print(len(a[0]))
	print(len(a[0][0]))

	filepath = 'data/reviews_categorical02.pkl'
	b = pickle.load(open(filepath,'rb'))

	filepath = 'data/reviews_categorical03.pkl'
	c = pickle.load(open(filepath,'rb'))

	filepath = 'data/reviews_categorical04.pkl'
	d = pickle.load(open(filepath,'rb'))

	filepath = 'data/reviews_categorical05.pkl'
	...
	filepath = 'data/transformed_reviews_2d.pkl'
